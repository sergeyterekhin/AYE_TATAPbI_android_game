...
public class RandCol : MonoBehaviour {
	...
	void Start () {
		if (main || right)
			...
			GetComponent <Renderer> ().material.color = new Vector4
            (aColor.r + Random.Range (0.1f, 0.3f), aColor.g + Random.Range (0.1f, 0.3f), aColor.b + Random.Range (0.1f, 0.3f), aColor.a);
	}
}
